...
class ImprovedGenerator(nn.Module):
    ...
    def __init__(self, input_channels=80, output_channels=80, hidden_channels=512):
        ...
        self.decoder = nn.Sequential(
            ...
            # Replace Tanh with learnable scaling
        )
...
class GlobalStats:
    ...
    #defaults based on common mel spectrogram ranges & updated during training with actual dataset statistics
    MEL_MEAN = -30.0
    MEL_STD = 20.0
    MEL_MIN = -80.0
    MEL_MAX = 0.0
    ...
    def update_from_batch(mel_batch):
        # Use moving average to update statistics from a batch of mel spectrograms
